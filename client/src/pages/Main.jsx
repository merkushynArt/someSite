            ...
            <div className="container">
               <div className="main-vacancies-wrapper">
                  <div className="main-vacancies__item">
                     ...
                     <MyLink1 to="/jobs">Подробнее</MyLink1>
                  </div>
            ...
            <div className="container">
               <div className="main-info__wrapper">
                  ...
                  <div className="main-info__text">
                     <p>
                        Работа на круизных лайнерах – это возможность воплотить в реальность заветные мечты: путешествия и интересные знакомства, разговорный английский и, конечно, финансовая стабильность. Работая в комфортных условиях и интересном обществе, вы сможете накопить собственное жилье, автомобиль или открытие бизнеса.
                     </p>
                  </div>
               </div>
            </div>
